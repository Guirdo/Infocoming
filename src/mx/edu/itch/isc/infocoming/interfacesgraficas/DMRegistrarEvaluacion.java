...
public class DMRegistrarEvaluacion extends PantallaModal {
    ...
    public JLabel titulo1, titulo2, matricula, nombre, curso, parcial, semanas, cal;
    ...
    public DMRegistrarEvaluacion() {
        ...
        parcial = new JLabel();
        parcial.setFont(new Font("Arial",2,12));
        semanas = new JLabel();
        ...
        this.add(curso, "wrap");
        this.add(new JLabel("Semanas pagadas: "));
        this.add(semanas, "wrap");
        this.add(new JLabel("Parcial: "));
        this.add(parcial, "wrap");
